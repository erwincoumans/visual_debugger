...
#define  SHARED_MEMORY_STREAM_MAX_NUM_FLOATS (1024 * 1024 / sizeof(float))
#else
//#define SHARED_MEMORY_MAX_STREAM_CHUNK_SIZE (8 * 1024 * 1024)
#define  SHARED_MEMORY_STREAM_MAX_NUM_FLOATS (8*1024 * 1024 / sizeof(float))
#endif
...
struct SharedMemoryBlock
{
	...
	float float_values_[SHARED_MEMORY_STREAM_MAX_NUM_FLOATS];
};
